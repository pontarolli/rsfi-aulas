...
| Faixa | Vantagem | Fraqueza |
|---|---|---|
| **2,4 GHz** | Alcance maior, atravessa paredes e objetos sólidos | Lenta, sofre interferência de micro-ondas e Bluetooth ("congestionada") |
| **5 GHz** | Alta velocidade (acima de 1 Gbps), menos interferência | Alcance curto, o sinal enfraquece ao encontrar barreiras físicas |
